...
// 若当前vue文件作为组件，defineProps获取的是父传子传过来的
// 若当前vue文件作为页面，defineProps获取的是页面（路由）的参数
...
<template>
  <view class="viewport">
    ...
    >
      ...
      <view class="loading-text">{{ item.finish ? '人家是有底线的~' : '正在加载...' }}</view>
    </scroll-view>
  </view>
</template>
